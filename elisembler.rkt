...
(define instructions
  #hash(
        (#px"add r([0-9]{1,2}), r([0-9]{1,2})" . "000101(bin \\2 4)01(bin \\1 4)")
        (#px"sub r([0-9]{1,2}), r([0-9]{1,2})" . "001011(bin \\2 4)01(bin \\1 4)")

        (#px"add r([0-9]{1,2}), ([0-9]{1,5})" . "000101000000(bin \\1 4)(bin \\2 16)")
